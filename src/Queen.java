...
public class Queen extends Piece {
	...
	public static final String img_file_white = "whitequeen.png";
	public static final String img_file_black = "blackqueen.png";
	...
	public boolean isValidMove(int nextI, int nextJ, Piece p){
		if(nextI == i && nextJ == j){
			return false;
		} else if(nextI != i && nextJ != j && nextI-nextJ != i-j && !(nextI == i-1 && nextJ == j+1) &&
